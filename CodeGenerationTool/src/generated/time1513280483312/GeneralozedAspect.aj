package generated.time1513280483312;

public aspect GeneralozedAspect extends SomeAspectClass {

	public pointcut abstractPointcut() : int;
	...
	public static pointcut staticAbstractPointcut() : int;
